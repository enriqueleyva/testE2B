...
(function() {
  ...
  let miBoton = document.getElementById("send");
  miBoton.addEventListener("click", function() {
    ...
    if (name && email && subject && message) {
      ...
      var settings = {
        "url": 'https://script.google.com/macros/s/AKfycbw-u2l95VjO5pXiUnJHQiO0nsajORKIG6b6I_V9Sv5k516M8z4-iuHuEYu27TetVw4r/exec',
        "type": "POST",
        "data":JSON.stringify({
            "nombre": name,
            "asunto": subject,
      ...
      Swal.fire('Por favor, completa todos los campos','','info')
    }
